...
<p>I think you can also be interested in <a href="http://ip.raspctl.com">RaspCTL DynamicDNS Service</a>. It's an awesome project
that gives you a domain name and allows you to share your projects with the Internet if you have a DynamicIP address. Check it out!</p>
